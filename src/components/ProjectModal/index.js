...
import { FaTimes, FaGithub, FaBlog, FaSignal, FaCode, FaRocket, FaCheckCircle } from 'react-icons/fa';
          ...
          <div className={styles.gettingStartedSection}>
            ...
            <div className={styles.gettingStartedContent}>
              <p>
                ...
                Follow the links below to get started with implementation and detailed documentation.
              </p>
            </div>
          </div>
